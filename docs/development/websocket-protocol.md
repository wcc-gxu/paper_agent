# Paper Agent v4.1 — WebSocket 通信协议

> iOS / Vue 客户端对接规范 | v11.1 | 2026-07-18
>
> v11.1 变更: Agent 子进程模型 (Supervisor 管理)/agent:status Hash 替代心跳/控制 Pub/Sub 启停
> v11.0 变更: AGENT_NOT_RUNNING error、queued status、doc_* 文档编辑工具、DiffPreview 卡片、document_edit capability
>
...
> v4.1: `AGENT_NOT_RUNNING` 由 API 查 `agent:status` Hash 返回（不再查 heartbeat key）。
