...
>
> v11.1 新增: AGENT_NOT_RUNNING 错误状态、7 种 agent state 反馈 (`starting`/`idle`/`busy`/`stopping`/`stopped`/`crashed`/`stalled`)
> v11.0 新增: AGENT_NOT_RUNNING error、queued status、doc_* 文档编辑工具、DiffPreview 卡片、document_edit capability
>
